...
const ProjectList = () => {
  ...
  useEffect(() => {
    wrapAsync(loadProjects(), { component: 'ProjectList', action: 'loadProjects' });
  }, [loadProjects, wrapAsync]);
    ...
    <div className="space-y-6">
      ...
      {error.isError && (
        <ErrorDisplay
          ...
          onRetry={() => wrapAsync(loadProjects(), { component: 'ProjectList', action: 'loadProjects' })}
          variant="inline"
        />
      )}
