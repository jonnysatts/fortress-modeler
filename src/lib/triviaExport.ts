/**
 * Trivia Export Functionality
 *
 * This module provides a direct export function for the Trivia product
 * with hardcoded values to ensure correct data in the Excel file.
 */
 ...
 */
export async function generateTriviaExcelReport(): Promise<void> {
  try {
 ...
 */
function addSummarySheet(workbook: XLSX.WorkBook): void {
 ...
 */
function addAssumptionsSheet(workbook: XLSX.WorkBook): void {
 ...
 */
function addForecastVsActualSheet(workbook: XLSX.WorkBook): void {
 ...
 */
function addWeeklyPerformanceSheet(workbook: XLSX.WorkBook): void {
 ...
 */
function addWeeklyAveragesSheet(workbook: XLSX.WorkBook): void {
 ...
 */
function addFinancialSummarySheet(workbook: XLSX.WorkBook): void {
