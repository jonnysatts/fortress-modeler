-- Migration: 20250717_fix_get_shared_projects_ambiguity.sql
-- This migration corrects the "column reference 'id' is ambiguous" error
-- in the get_shared_projects function by explicitly qualifying column names.
...
BEGIN
    ...
    WHERE 
        ...
        AND ps.shared_with_email = (
            -- Corrected subquery with explicit column qualification
...
DO $$
BEGIN
    RAISE NOTICE '=== AMBIGUOUS COLUMN FIX APPLIED ===';
    RAISE NOTICE 'Corrected get_shared_projects() function to resolve "id" ambiguity';
END $$;
